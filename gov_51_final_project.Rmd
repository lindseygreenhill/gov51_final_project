...
Before running a regression, we wanted to visualize the distribution of language uses across channels to get an initial sense of the trends. Before talking about the results and graphics, we will give further details on the dictionaries we used to classify the language. 
